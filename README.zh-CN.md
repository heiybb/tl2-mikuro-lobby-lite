...
1.26 选了自建服务器时,这一局游戏里的 TapTap 登录框会换成 Mikuro 的:按钮走服务器的 Auth URL 登录,
不需要 TapTap 账号;联机游戏列表顶上也会显示当前连的是哪台服务器。

<img src="docs/mikuro-login.png" alt="经启动器启动时 1.26 的登录框" width="360">
